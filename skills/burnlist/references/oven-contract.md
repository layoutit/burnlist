...
Default Ovens ship with the skill. Custom Ovens are created once under ignored `.local/burnlist/ovens/` state. There is no dashboard update endpoint. Manual changes affect only future Runs.
