...
The structural schema is `ovens/differential-testing/data.schema.json`. The packaged validator is authoritative because it also recomputes relationships that JSON Schema cannot express.
