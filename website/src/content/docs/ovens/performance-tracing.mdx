...
The detail page renders through the `.oven` engine: `performance-tracing.oven` compiles to `performance-tracing.ir.json`. See [The .oven system](/ovens/oven-system) and the [.oven DSL reference](/ovens/dsl-reference).
