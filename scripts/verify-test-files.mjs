export const verificationTestFiles = [
  ...
  "src/loops/adapters/codex-cli.test.mjs",
  "src/loops/adapters/normalized-invocation.test.mjs",
  "src/loops/agents/profile.test.mjs",
  ...
  "src/loops/run/binder.test.mjs",
  "src/loops/run/run-claim.test.mjs",
  "src/loops/run/reviewer-isolation.test.mjs",
