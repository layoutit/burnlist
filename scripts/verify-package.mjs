...
const required = [
  ...
  "ovens/differential-testing/data.schema.json",
  "skills/burnlist/references/differential-testing-data.md",
  "skills/burnlist/references/differential-testing-adapter-sdk.md",
  "ovens/differential-testing/adapter-sdk.mjs",
  "ovens/differential-testing/contract.mjs",
  "ovens/differential-testing/data-contract.mjs",
  "ovens/differential-testing/transport.mjs",
