...
function Cell({ cell }: { cell: LayoutCell }) {
  ...
  if (structural.has(cell.kind)) return <box position="absolute" left={cell.rect.x} top={cell.rect.y} width={cell.rect.width} height={cell.rect.height} overflow="hidden"><text>{text}</text></box>;
